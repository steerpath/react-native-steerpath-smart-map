	...
	"services": {
		...
		"smartmap": {
			"default": {
				...
				"nonSelectableCssClasses": ["infrastructure_stairs", "infrastructure_lift", "category_stairs", "category_other", "infrastructure_hole", "category_cover_poi", "infrastructure_department", "infrastructure_wing"],
				...
				"mapStylePath": "/style/default_v2.json",
		...
		"search": {
			"default": {
				"nonSearchableCssClasses": ["infrastructure_stairs", "infrastructure_lift", "category_stairs", "category_other", "infrastructure_hole", "category_cover_poi", "infrastructure_department", "infrastructure_wing"],
				"searchSuggestions": [{
